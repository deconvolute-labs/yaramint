...
from yaramint.adapters import get_adapter
from yaramint.errors import ConfigurationError
from yaramint.models.optimization_config import OptimizationConfig, SelectionConfig
from yaramint.models.optimizer import OptimizationReport, OptimizationResult
...
from yaramint.utils.config import load_config
from yaramint.utils.logger import get_logger, log_named_value
...
def run(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        if best_run:
            ...
            logger.info(
                f"ymint generate --input {args.input} "
